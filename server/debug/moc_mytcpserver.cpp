...
QT_MOC_LITERAL(1, 12, 14), // "sendDescriptor"
QT_MOC_LITERAL(2, 27, 0), // ""
QT_MOC_LITERAL(3, 28, 7), // "qintptr"
QT_MOC_LITERAL(4, 36, 6) // "handle"

    },
    "myTcpServer\0sendDescriptor\0\0qintptr\0"
    "handle"
};
...
void myTcpServer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sendDescriptor((*reinterpret_cast< qintptr(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&myTcpServer::sendDescriptor)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void myTcpServer::sendDescriptor(qintptr _t1)
{
