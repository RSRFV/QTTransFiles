...
QT_MOC_LITERAL(4, 33, 10), // "clientData"
QT_MOC_LITERAL(5, 44, 13), // "getClientData"
QT_MOC_LITERAL(6, 58, 12), // "recvFinished"
QT_MOC_LITERAL(7, 71, 8) // "fileName"

    },
    "recvWork\0connectOK\0\0disconnectOK\0"
    "clientData\0getClientData\0recvFinished\0"
    "fileName"
};
...
void recvWork::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: _t->recvFinished((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            using _t = void (recvWork::*)(QStringList );
        ...
        {
            using _t = void (recvWork::*)(QStringList );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&recvWork::getClientData)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 1
void recvWork::disconnectOK(QStringList _t1)
{
...
// SIGNAL 2
void recvWork::getClientData(QStringList _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
